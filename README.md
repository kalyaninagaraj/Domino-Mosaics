...
To learn more about domino mosaics, both the art form and its interpretation as the solution to an integer program, watch the mathematician-artist [Robert Bosch](https://www.oberlin.edu/bob-bosch) of Oberlin College give [this talk at Google](https://www.youtube.com/watch?v=g3CiVrN-BnY). 
